...
def calculate_hybrid_scores(uncertainty, feature_importance_scores, alpha=0.75, beta=1.25):
    default_weight = 0.05
...
def main(args):
    ...
    exp_dir = exp_dir.joinpath('part_seg_a2re_m2_dummy')
    exp_dir.mkdir(exist_ok=True)
    ...
    TEST_DATASET=My_H5Dataset(os.path.join(BASE_DIR2, 'wheat_a2re2k/VAL_A2RE2K_Wheat.h5'),normal_channel=False)
