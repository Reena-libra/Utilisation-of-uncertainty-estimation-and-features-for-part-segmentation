...
def main(args):
    ...
    exp_dir = exp_dir.joinpath('part_seg_p2r_d2')
    exp_dir.mkdir(exist_ok=True)
    ...
    TRAIN_DATASET=My_H5Dataset(os.path.join(BASE_DIR2, 'wheat_p2r_d/TRAIN_P2R_D.h5'),normal_channel=False)
    TEST_DATASET=My_H5Dataset(os.path.join(BASE_DIR2, 'wheat_p2r_d/VAL_P2R_D.h5'),normal_channel=False)
